...
print("Generating Figure 2: Distribution of LIMIT_BAL...")
plt.figure(figsize=(8, 4))
sns.histplot(df['LIMIT_BAL'], kde=True, bins=30, color='skyblue')
plt.title('Figure 2: Distribution of LIMIT_BAL')
plt.tight_layout()
plt.savefig('Figure_2_Distribution_of_LIMIT_BAL.png', dpi=300)
plt.close()

print("Generating Figure 3: Distribution of AGE...")
plt.figure(figsize=(8, 4))
sns.histplot(df['AGE'], kde=True, bins=20, color='salmon')
plt.title('Figure 3: Distribution of AGE')
plt.tight_layout()
plt.savefig('Figure_3_Distribution_of_AGE.png', dpi=300)
plt.close()

print("Generating Figure 4: Boxplot of LIMIT_BAL...")
plt.figure(figsize=(8, 3))
sns.boxplot(x=df['LIMIT_BAL'], color='lightgreen')
plt.title('Figure 4: Boxplot of LIMIT_BAL')
plt.tight_layout()
plt.savefig('Figure_4_Boxplot_of_LIMIT_BAL.png', dpi=300)
plt.close()

print("Generating Figure 5: Distribution of SEX...")
plt.figure(figsize=(6, 4))
sns.countplot(data=df, x='SEX', palette='pastel')
plt.title('Figure 5: Distribution of SEX (1=Male, 2=Female)')
plt.tight_layout()
plt.savefig('Figure_5_Distribution_of_SEX.png', dpi=300)
plt.close()

print("Generating Figure 6: Distribution of EDUCATION...")
plt.figure(figsize=(7, 4))
sns.countplot(data=df, x='EDUCATION', palette='muted')
plt.title('Figure 6: Distribution of EDUCATION')
plt.tight_layout()
plt.savefig('Figure_6_Distribution_of_EDUCATION.png', dpi=300)
plt.close()
...
print("Generating Figure 14: ROC Curve Plot Comparison...")
plt.plot([0, 1], [0, 1], 'k--', label='Base Rate (Chance)')
plt.xlim([0.0, 1.0])
plt.ylim([0.0, 1.05])
plt.xlabel('False Positive Rate (FPR)')
plt.ylabel('True Positive Rate (TPR)')
plt.title('Figure 14: ROC Curve Plot Comparison')
plt.legend(loc="lower right")
plt.tight_layout()
plt.savefig('Figure_14_ROC_Curve_Comparison.png', dpi=300)
plt.close()
...
print("\nGenerating Figure 15: Model Performance Comparison Bar Chart...")
...
plt.title('Figure 15: Model Performance Comparison Dashboard')
plt.ylabel('Score Value')
plt.xticks(rotation=15)
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()
plt.savefig('Figure_15_Performance_Comparison.png', dpi=300)
plt.close()
...
print("Generating Figure 18: SHAP Beeswarm Plot...")
plt.figure(figsize=(10, 6))
shap.summary_plot(shap_vals_matrix, shap_sample, show=False)
plt.title('Figure 18: SHAP Feature Importance Summary (Beeswarm)', fontsize=12, pad=20)
plt.tight_layout()
plt.savefig('Figure_18_SHAP_Summary_Beeswarm.png', dpi=300)
plt.close()

print("Generating Figure 19: SHAP Bar Plot...")
plt.figure(figsize=(10, 6))
shap.summary_plot(shap_vals_matrix, shap_sample, plot_type="bar", show=False)
plt.title('Figure 19: SHAP Feature Importance (Average Magnitude Bar)', fontsize=12, pad=20)
plt.tight_layout()
plt.savefig('Figure_19_SHAP_Summary_Bar.png', dpi=300)
plt.close()
